                ...
                <div className="sidebar-sticky">
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            <NavLink exact={true} className="nav-link" to={ '/welcomes'}>
                        ...
                        <li className="nav-item" >
                                <NavLink exact={true} className="nav-link" to={'/contacto'}>
                            ...
                            <li className="nav-item" >
                                <NavLink exact={true} className="nav-link" to={'/ReactWidgetsForm'}>
